...
function smartTravelFormSubmitHandler() {
    const travelForm = document.forms['smartTravelForm']
    const submitterButton = document.getElementById('smartTravelSubmitButton')
